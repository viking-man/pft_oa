...
<div class="app-cam">
    <form action="/login.do" method="post">
        ...
        <%--<div class="login-social-link">--%>
            <%--<a href="https://open.work.weixin.qq.com/wwopen/sso/qrConnect?appid=ww100000a5f2191&agentid=1000000&redirect_uri=http%3A%2F%2Fwww.oa.com&state=web_login@gyoss9" class="facebook">--%>
                <%--微信登录--%>
            <%--</a>--%>

            ...
            <div class="md">
                ...
                <div>
                    <div style="margin:10px;display:inline;padding: 10px 20px;height: 30px;width: 60px;"
                        ...
                        <input type="submit" value="新建" style="height: 30px;width: 60px;" id="user.create">
                    </div>

                    <form style="margin:10px;display:inline;padding: 10px 20px;"
                          action="/oa/user/role/query.do" method="post">
                        <input type="submit" value="查询" style="height: 30px;width: 60px;" id="user.query">
                    </form>
                ...
                <table class="table table-bordered" id="rolesdisplay">
                    ...
                    <c:forEach items="${data}" var="role" varStatus="i">
                        <tr id="${role.id}">
                            <td>${role.rolecode}</td>
                            <td>${role.rolename}</td>
                            ...
                            <td contenteditable="false">
                                <a href="#=${role.id}" data-toggle="modal" data-target="#editModal"
